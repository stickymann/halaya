...
$(document).ready(function()
{
	...
	if($('#current_no').val() == '0')
	{
		...
		$('#start_date').focus(function() {bicrmonthly.CreateAltID();});

		$('#end_date').keyup(function() {bicrmonthly.CreateAltID();});
		$('#end_date').change(function() {bicrmonthly.CreateAltID();});
		$('#end_date').focus(function() {bicrmonthly.CreateAltID();});
	}
});
...
var bicrmonthly = new function() 
{
	this.CreateAltID = function()
	{
		...
		description = cc_id + " for period " + start_date + " to " + end_date;
