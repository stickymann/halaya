...
(function($)
{
	...
	{
		indexOf:function(o){for(var i=0,len=this.length;i<len;i++){if(this[i]==o){return i;}}return -1;},
		remove:function(o){ var _3b7=this.indexOf(o); if(_3b7!=-1){this.splice(_3b7,1);}return this;},
		removeById:function(_3b8,id){  for(var i=0,len=this.length;i<len;i++){ if(this[i][_3b8]==id){ this.splice(i,1); return this; }}return this;}
	});
