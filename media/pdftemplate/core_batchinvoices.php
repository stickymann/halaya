...
$pggroup = 1; $current_startpage = 1; $current_endpage = 1;
$pageGroup[1] = array('start'=>$current_startpage,'end'=>$current_endpage);
...
{	 
	...
	$current_endpage = $this->pdf->getPage();
	$next_startpage = $current_endpage + 1;
	$pageGroup[$pggroup] = array('start'=>$current_startpage,'end'=>$current_endpage);
	...
	for($pagenum=1; $pagenum < $numpages+1; $pagenum++)
	{
		...
		$this->pdf->setPage($page_r['start'] + $pagenum - 1 , false);
	...
	$current_startpage = $next_startpage;
	$pggroup++;
}
//############## invoice ends here ############## 
