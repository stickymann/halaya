...
abstract class Controller_Include extends Controller 
{
	 ...
	 *  Setup routine.
	 */
	public $global_app_title = "Soulmap";
	public $auto_render = TRUE;

	//javascript
	public $randomstring = ""; 
	public $js = array(
		//'jquery' => 'media/js/jquery-1.8.0.min.js',
		//'jquery' => 'media/js/jquery-1.8.3.min.js',
		'jquery' => 'media/js/jquery-1.7.0.min.js',
	...
	public $img = array(
		'logo_front' => 'media/img/login/lovecenter.750w.png',
		'logo_app' => 'media/img/banner/lovecenter.logo.small.png',
