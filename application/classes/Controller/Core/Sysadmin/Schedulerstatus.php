...
/**
 * Displays scheduler daemon status and start/stop options. 
 *
 * $Id: Schedulerstatus.php 2014-03-03 17:00:49 dnesbit $
 *
 * @package		Halaya
 * @module	    core
 ...
 * @license      
 */
class Controller_Core_Sysadmin_Schedulerstatus extends Controller_Include
{
	...
	public function __construct()
    {
		...
		$this->OBJPOST = $_POST;
		$this->param['param_id']	= "core_settings_schedulerstatus";
		$this->param['controller']	= "schedulerstatus";
		$this->param['inputview']	= "default_input";
		$this->param['pageheader']	= "Task Scheduler Daemon Status";
	...
	function input_form()
	{
		...
		$pagebody->add('<br><div id="scheduler_status"></div>');
...
} //End Controller_Core_Sysadmin_Schedulerstatus
